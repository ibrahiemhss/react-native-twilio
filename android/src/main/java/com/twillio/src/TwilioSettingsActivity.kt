...
import com.twillio.src.utils.isH264Supported

class TwilioSettingsActivity : ReactActivity() {
    companion object {
...
//            setupDemoAccessTokenPreferences(
//                SettingsActivity.PREF_DEMO_ACCESS_TOKEN,
//                SettingsActivity.PREF_DEMO_ACCESS_TOKEN_DEFAULT,
//                findPreference(SettingsActivity.PREF_DEMO_ACCESS_TOKEN) as EditTextPreference?
//            )
        }
