  ...
  private static final String TAG = "CustomTwilioVideoView";
            ...
            newCameraCapturer = new CameraCapturer(
                    ...
                    new CameraCapturer.Listener() {
                        ...
                        public void onCameraSwitched(String newCameraId) {
                            ...
                            pushEvent(CustomTwilioVideoView.this, Events.ON_CAMERA_SWITCHED, event);
                        }
    ...
    private boolean createLocalVideo(boolean enableVideo, String cameraType) {
        ...
        if (cameraCapturer == null) {
            ...
            pushEvent(CustomTwilioVideoView.this, Events.ON_CONNECT_FAILURE, event);
            return false;
        }
    ...
    public void onHostDestroy() {
         ...
         */
        if (room != null && room.getState() != State.DISCONNECTED) {
            room.disconnect();
    ...
    public void connectToRoom() {
        ...
        pushEvent(CustomTwilioVideoView.this, Events.ON_LOCAL_PARTICIPANT_SUPPORTED_CODECS, event);
    ...
    public void setAudioType() {
      AudioDeviceInfo[] devicesInfo = new AudioDeviceInfo[0];
      ...
      boolean hasNonSpeakerphoneDevice = false;
        for (int i = 0; i < devicesInfo.length; i++) {
          int deviceType = 0;
          if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            deviceType = devicesInfo[i].getType();
          }
          if (
...
//            audioManager.setSpeakerphoneOn(true);
    ...
    public void toggleVideo(boolean enabled) {
        ...
        if (localVideoTrack != null) {
            ...
            pushEvent(CustomTwilioVideoView.this, Events.ON_VIDEO_CHANGED, event);
        }
    }
    ...
    public void toggleAudio(boolean enabled) {
        if (localAudioTrack != null) {
            ...
            pushEvent(CustomTwilioVideoView.this, Events.ON_AUDIO_CHANGED, event);
        }
    }
        ...
        if (room != null) {
            room.getStats(new StatsListener() {
                ...
                public void onStats(List<StatsReport> statsReports) {
                    ...
                    pushEvent(CustomTwilioVideoView.this, Events.ON_STATS_RECEIVED, event);
                }
            });
        }
    }
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
                ...
                pushEvent(CustomTwilioVideoView.this, Events.ON_CONNECTED, event);
            ...
            public void onDisconnected(Room room, TwilioException e) {
                ...
                pushEvent(CustomTwilioVideoView.this, Events.ON_DISCONNECTED, event);
            ...
            public void onDominantSpeakerChanged(Room room, RemoteParticipant remoteParticipant) {
                ...
                pushEvent(CustomTwilioVideoView.this, Events.ON_DOMINANT_SPEAKER_CHANGED, event);
            }
        };
    }
    ...
    private RemoteParticipant.Listener mediaListener() {
        return new RemoteParticipant.Listener() {
            ...
            public void onAudioTrackSubscribed(RemoteParticipant participant, RemoteAudioTrackPublication publication, RemoteAudioTrack audioTrack) {
                ...
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_ADDED_AUDIO_TRACK, event);
            }
            ...
            public void onAudioTrackUnsubscribed(RemoteParticipant participant, RemoteAudioTrackPublication publication, RemoteAudioTrack audioTrack) {
                WritableMap event = buildParticipantVideoEvent(participant, publication);
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_REMOVED_AUDIO_TRACK, event);
            }
            ...
            public void onDataTrackSubscribed(RemoteParticipant remoteParticipant, RemoteDataTrackPublication remoteDataTrackPublication, RemoteDataTrack remoteDataTrack) {
                ...
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_ADDED_DATA_TRACK, event);
            ...
            public void onDataTrackUnsubscribed(RemoteParticipant remoteParticipant, RemoteDataTrackPublication remoteDataTrackPublication, RemoteDataTrack remoteDataTrack) {
                WritableMap event = buildParticipantDataEvent(remoteParticipant, remoteDataTrackPublication);
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_REMOVED_DATA_TRACK, event);
            }
...
//                publication.getRemoteAudioTrack().enablePlayback(false);
                WritableMap event = buildParticipantVideoEvent(participant, publication);
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_ENABLED_AUDIO_TRACK, event);
            }

            @Override
            public void onAudioTrackDisabled(RemoteParticipant participant, RemoteAudioTrackPublication publication) {
                WritableMap event = buildParticipantVideoEvent(participant, publication);
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_DISABLED_AUDIO_TRACK, event);
            }

            @Override
            public void onVideoTrackEnabled(RemoteParticipant participant, RemoteVideoTrackPublication publication) {
                WritableMap event = buildParticipantVideoEvent(participant, publication);
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_ENABLED_VIDEO_TRACK, event);
            }

            @Override
            public void onVideoTrackDisabled(RemoteParticipant participant, RemoteVideoTrackPublication publication) {
                WritableMap event = buildParticipantVideoEvent(participant, publication);
                pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_DISABLED_VIDEO_TRACK, event);
            }
            ...
            public void onNetworkQualityLevelChanged(RemoteParticipant remoteParticipant, NetworkQualityLevel networkQualityLevel) {
                ...
                pushEvent(CustomTwilioVideoView.this, Events.ON_NETWORK_QUALITY_LEVELS_CHANGED, event);
            }
        };
    }
    ...
    private void addParticipantVideo(Participant participant, RemoteVideoTrackPublication publication) {
        ...
        pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_ADDED_VIDEO_TRACK, event);
    }
    ...
    private void removeParticipantVideo(Participant participant, RemoteVideoTrackPublication deleteVideoTrack) {
        ...
        pushEvent(CustomTwilioVideoView.this, Events.ON_PARTICIPANT_REMOVED_VIDEO_TRACK, event);
    }
    // ===== EVENTS TO RN ==========================================================================
    ...
    private RemoteDataTrack.Listener remoteDataTrackListener() {
        return new RemoteDataTrack.Listener() {
            ...
            public void onMessage(RemoteDataTrack remoteDataTrack, String message) {
                ...
                pushEvent(CustomTwilioVideoView.this, Events.ON_DATATRACK_MESSAGE_RECEIVED, event);
            }
        };
    }
}
